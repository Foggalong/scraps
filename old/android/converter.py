...
#program
title = 'Converter'
message = 'Welcome to the Converter!'
alert(title, message)
PositiveButtonText('Continue')
show()
a = 1
while a == 1:
    try:
	alert('What type of units do you wish to convert?')
	choicelist(['Length', 'Area', 'Mass', 'Speed', 'Temperature', 'Time'])
	if response == 'Lenght':
		b = 1
		while b == 1:
			alert('What is the unit you wish to convert from?')
			choicelist(['Kilometres', 'Metres', 'Centimetres', 'Millimetres', 'Miles', 'Inches', 'Feet', 'Yards'])	
			if response == 'Kilometres':
				c = 1
				while c == 1:
					alert('What is the unit you wish to convert to?')
					choicelist(['Metres', 'Centimetres', 'Millimetres', 'Miles', 'Inches', 'Feet', 'Yards'])
					if response == 'Metres':
						conversion(n + 'Kilometres = ' + n*1000 + 'Metres')
					if response == 'Centimetres':
						conversion(n + 'Kilometres = ' + n*100000 + 'Centimetres')
					if response == 'Millimetres':
						conversion(n + 'Kilometres = ' + n*1000000 + 'Millimetres')
					if response == 'Miles':
						conversion(n + 'Kilometres = ' + n*0.6214 + 'Miles')
					if response == 'Inches':
						conversion(n + 'Kilometres = ' + n*39370 + 'Inches')
					if response == 'Feet':
						conversion(n + 'Kilometres = ' + n*3281 + 'Feet')
					if response == 'Yards':
						conversion(n + 'Kilometres = ' + n*1094 + 'Yards')
					else:
						c = c+1
			if response == 'Metres':
				c = 1
				while c == 1:
					alert('What is the unit you wish to convert to?')
					choicelist(['Kilometres', 'Centimetres', 'Millimetres', 'Miles', 'Inches', 'Feet', 'Yards'])
					if response == 'Kilemetres':
						conversion(n + 'Metres = ' + n*0.001 + 'Kiloetres')
					if response == 'Centimetres':
						conversion(n + 'Metres = ' + n*100 + 'Centimetres')
					if response == 'Millimetres':
						conversion(n + 'Metres = ' + n*1000 + 'Millimetres')
					if response == 'Miles':
						conversion(n + 'Metres = ' + n*0.0006214 + 'Miles')
					if response == 'Inches':
						conversion(n + 'Metres = ' + n*39.37 + 'Inches')
					if response == 'Feet':
						conversion(n + 'Metres = ' + n*3.281 + 'Feet')
					if response == 'Yards':
						conversion(n + 'Metres = ' + n*1.094 + 'Yards')
					else:
						c = c+1
			if n == 3:
				c = 1
